      ...
      <article className="prose prose-lg dark:prose-invert max-w-4xl mx-auto">
        ...
        <ul className="space-y-4 mb-8">
          <li>
            ...
            <p>
              An intelligent chatbot that provides contextual responses about my
              skills, projects, and blog posts. Built with a custom response
              generation system that understands various types of queries and
              provides relevant information from the portfolio data.
            </p>
          </li>
          <li>
          ...
          <li>
            ...
            <p>
              A platform for sharing in-depth technical articles about software
              development, AI, and technology trends. The blog section features
              a clean, readable layout optimized for technical content.
            </p>
          </li>
          <li>
        ...
        <ul className="list-disc ml-6 mb-8">
          <li>
            Integration with OpenAI&apos;s GPT for more advanced chat capabilities
          </li>
        ...
        <div className="border-t pt-8 mt-12">
          <p className="text-muted-foreground">
            If you&apos;re interested in learning more about this project or have any
            questions, feel free to reach out or check out the source code on
            GitHub!
          </p>
        </div>
      </article>
